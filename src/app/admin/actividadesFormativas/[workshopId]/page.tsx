...
const page = async ({ params }: { params: { workshopId: shortUUID.SUUID } }) => {
  ...
  return (
    <div className="space-y-6  min-h-screen">
      <section className="space-y-3 bg-white rounded-lg p-8">
        ...
        <div className="space-y-2">
          <div className="pace-y-2 border-l-2 border-green-500 pl-1.5  sm:pl-3">
          ...
          {description && <h2 className="text-xl  font-semibold text-green-500">Descripción:</h2>}{' '}
