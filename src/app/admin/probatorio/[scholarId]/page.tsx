...
import ProbationAccordion from '@/components/ProbationAccordion';
...
import { AddressIcon, CalendarIcon, DniIcon, EmailIcon, PhoneIcon } from 'public/svgs/svgs';
...
const page = async ({
  ...
  return (
    <section className="flex flex-col gap-4 lg:p-6 pt-0">
          ...
          <div className="w-full flex  lg:flex-row justify-between items-center">
            <div className="flex gap-4 items-center text-primary-light">
              ...
              <Tooltip content="Ver perfil publico">
                <Link href={`/admin/becarios/${scholarId}`}>
      ...
      <ProbationAccordion scholarInProbation={scholar} />
    </section>
  );
};
