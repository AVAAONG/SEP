...
const page = async ({
    ...
    return (
        <div className="space-y-6 text-primary p-8">
            <div className="flex flex-col space-y-3"><span className="pipe w-fit text-green-500">Taller ProExcelencia</span>
                <h1 className="text-2xl font-semibold leading-none tracking-tight text-primary md:text-5xl">{title}</h1>
