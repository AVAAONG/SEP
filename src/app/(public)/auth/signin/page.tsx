...
const page = () => {
  ...
  const scholarCallbackUrl = searchParams.get("callbackUrl") || "/becario/adsfdsfdf/dashboard";
      ...
      <section className="justify-center px-4 md:px-0 md:flex md:w-2/3">
        <div className="w-full max-w-sm py-4 mx-auto my-auto min-w-min md:py-9 md:w-7/12">
          ...
          <p className="text-xs md:text-sm text-slate-400">
            ...
            <a className="text-green-600 text-xs md:text-sm font-semibold" href="/auth/signup">
              Regístrate.
            </a>
          </p>
          <div className="my-4">
            ...
            <form className="new_user" id="new_user" action="/register" acceptCharset="UTF-8" method="post">
              ...
              <div className="mb-3 flex flex-col gap-2">
                <label htmlFor="user_password" className="text-sm text-slate-400">
                  Contraseña
                </label>
                <input
                  autoComplete="current-password"
                  className="focus:outline-none focus:outline-offset-0  focus:outline-emerald-600  py-1 px-3 rounded-md w-full  bg-emerald-950 ring-1 ring-emerald-900 border-emerald-700"
                  required={true}
                  type="password"
                  name="user[password]"
                  id="user_password"
              ...
              <div className="flex justify-between mb-4">
                <a className="text-xs text-slate-400 hover:text-green-600" href="/password/new">
              ...
              <button
                name="button"
                type="submit"
                className="bg-emerald-950 hover:bg-green-600 hover:border-none font-semibold box-border border-emerald-900 border-2 py-1 px-4 w-full rounded-md"
              >
                Entra
              </button>
            </form>
          ...
          <div className="flex">
            ...
            <a
              onClick={() => signIn("google", { scholarCallbackUrl })}
              role="button"
              className="bg-green-600 hover:bg-emerald-950 border-2 border-emerald-950 hover:border-green-600 text-white font-semibold py-2 px-4 rounded-md w-full flex justify-center gap-4"
            >
              <svg
