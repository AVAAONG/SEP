 ...
 */
const page = () => (
  <div className="dark:bg-dark bg-light z-10">
    <div className="min-h-screen px-6 flex flex-col items-center justify-center">
      ...
      <div className="mt-2 flex flex-col items-center justify-center text-center max-w-sm gap-4">
        <h3 className="text-2xl font-medium ">¡Ahora revisa tu correo electrónico!</h3>
        <p className="md:text-lg">
          Desde <span className="font-medium text-primary-light">ProExcelencia</span> te hemos
          enviado un enlace de inicio de sesión a tu correo.
        </p>
        <Link
          href={'https://mail.google.com/mail/u/0/'}
          className=" w-full focus:outline-none text-white bg-primary-light hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 "
        >
          Revisar Correo
        </Link>
      </div>
