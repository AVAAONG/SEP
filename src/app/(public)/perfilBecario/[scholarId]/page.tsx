  ...
  return (
    <main className="min-h-screen">
      <section className="flex flex-col md:flex-row gap-4 w-full ">
        <div className="px-2 py-10 lg:w-1/3 dark:bg-gradient-to-b min-h-screen dark:from-emerald-950 dark:to-slate-950 items-center flex flex-col gap-4">
        ...
        <div className="w-full flex-1 bg-gray-100 flex flex-col gap-4 py-36 px-10">
          <PublicAccordion totalHours={totalHours} totalHoursBySkill={totalHoursBySkill} />
