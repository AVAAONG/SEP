      ...
      <form className="flex justify-center">
        <div className="grid grid-cols-7 gap-4 w-full justify-center">
          <div className="col-span-6 ">
            ...
            >
              Lugar donde realizó la actividad
            </label>
          ...
          <div className="col-span-6 ">
            <label
              ...
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >
              Indique el número de horas dedicadas a la actividad.
            </label>
          ...
          <div className="col-span-6 ">
            <label
              ...
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >
              Nombre de la organización, empresa o institución beneficiada
            </label>
          ...
          <div className="col-span-6 ">
            <label
              ...
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >
              Nombre del beneficiario o supervisor responsable
            </label>
            <input type="text" required className="bg-white" />
          </div>
          <div className="col-span-6 ">
            <label
              ...
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >
              Describa brevemente la actividad realizada
            </label>
