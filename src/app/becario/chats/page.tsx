      ...
      <div className="h-full w-full flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 dark:from-emerald-600 dark:to-emerald-700 rounded-xl shadow-lg p-6 text-white">
            <div className="flex items-start justify-between mb-4">
              <div>
                <p className="text-sm font-medium text-emerald-100 uppercase tracking-wide">Chats Completados</p>
                <div className="flex items-baseline gap-2 mt-2">
                  <p className="text-5xl font-bold">{attendedChat?.length}</p>
                  <p className="text-2xl font-semibold text-emerald-100">/ 10</p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold">{((attendedChat?.length / 10) * 100).toFixed(0)}%</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-red-600 dark:text-red-400 mt-2">
                  {notAttendedChats + justifiedAbsences + canceledAbsences}
                </p>
              </div>
          ...
          <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Nivel frecuente</p>
                <p className="text-3xl font-bold text-purple-600 dark:text-purple-400 mt-2">
                  {parseChatLevelFromDatabase(mostCommonLevel)}
                </p>
              </div>
