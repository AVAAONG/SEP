                ...
                <main className="p-4 md:ml-64 h-auto pt-16">
                    ...
                    <footer className="p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
                        <ul className="flex flex-wrap items-center mb-6 space-y-1 md:mb-0">
                            <li><a href="#" className="mr-4 text-sm font-normal text-gray-500 hover:text-green-500 md:mr-6 dark:text-gray-400">Terminos y condiciones</a></li>
                            <li><a href="#" className="mr-4 text-sm font-normal text-gray-500 hover:text-green-500 md:mr-6 dark:text-gray-400">Politica de Privacidad</a></li>
                            <li><a href="#" className="text-sm font-normal text-gray-500 hover:text-green-500 dark:text-gray-400">Contacto</a></li>
                        </ul>
                    ...
                    <p className="my-10 text-sm text-center text-green-500">
