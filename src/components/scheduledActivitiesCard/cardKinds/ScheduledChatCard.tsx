...
interface ScheduledChatCardI {
  chat: ChatWithSpeaker;
  children: React.ReactNode;
}
const ScheduledChatCard: React.FC<ScheduledChatCardI> = ({ chat, children }) => {
  const { title, id, start_dates, end_dates, speaker, avalible_spots, level, modality, platform } =
    chat;
  return (
    <Checkbox
      radius="sm"
...
export default ScheduledChatCard;
