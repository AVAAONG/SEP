        ...
        <div className="w-full flex box-border flex-wrap justify-between items-center lg:items-start gap-8">
          <div className="max-w-sm m-auto flex flex-wrap justify-center lg:justify-start gap-4">
            <p className="text-center lg:text-start">
              Apoyamos la educación integral y formación de jóvenes venezolanos con valores sociales y morales elevados
              para contribuir al desarrollo armónico del país en un ambiente de convivencia y amistad internacional en
              alianza con personas y organizaciones comprometidas con Venezuela
            </p>
          </div>
