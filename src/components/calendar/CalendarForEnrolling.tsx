 ...
 */
const CalendarForEnrrolling = ({ events, modal }: { events: any[], modal?: React.ReactNode }) => {
                ...
                Content={() => (
                    <div className='flex flex-col gap-2 px-4'>
                        ...
                        <div className='flex gap-1'>
                            ...
                            <p >de {selectedEvent?.start?.toLocaleTimeString('es-ES', {
                                hour: 'numeric',
                                minute: '2-digit',
                                hour12: true,
                            })} hasta las  {selectedEvent?.end?.toLocaleTimeString('es-ES', {
                                hour: 'numeric',
                                minute: '2-digit',
                                hour12: true,
                            })}
                        ...
                        <div>
                            <p className='font-bold'>{selectedEvent.speakerIds.length > 1 ? "Facilitadores" : "Facilitador"}</p>
                        ...
                        <div className='flex gap-1'>
                            <p className='font-bold'>{selectedEvent.modality === 'ONLINE' ? "Plataforma" : "Lugar"}</p>
