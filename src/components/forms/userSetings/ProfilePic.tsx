        ...
        <div className="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
            ...
            <div>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button type="button" className="py-2 px-3 text-sm font-medium text-red-900 focus:outline-none bg-transparent rounded-lg border border-red-700 hover:bg-red-700 hover:text-white  dark:text-red-400 dark:border-red-600 dark:hover:text-white dark:hover:bg-red-700">
                        Borrar foto actual
                    </button>
                </div>
            </div>
