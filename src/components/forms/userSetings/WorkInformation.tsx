                ...
                <form action="#">
                    <div className="grid grid-cols-2 gap-6">
                        <div className="col-span-2 sm:col-span-1">
                            <label htmlFor="isCurrentlyWorking" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">¿Te Encuentras trabajando actualmente?</label>
                            <select {...register("isCurrentlyWorking")} className="bg-gray-50 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            ...
                            <input type='text' {...register("positionHeld")} placeholder='Community Manager' required />
                        </div>

                        <div className="col-span-2 sm:col-span-1">
                            <label htmlFor="collage" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Horas de trabajo Semanales</label>
