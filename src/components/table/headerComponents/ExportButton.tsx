  ...
  return (
    <div className="p-6">
      <p className="text-sm italic">
        Ten en cuenta que solo los datos que se muestran en la tabla son los unicos que se
        exportaran.
      </p>
    </div>
  );
...
const ExportButton = () => {
  return (
    <Modal
      title="Elige la opcion para exportar estos datos"
      onConfirm={() => console.log('adsfdsf')}
      content={s()}
    >
      <button
