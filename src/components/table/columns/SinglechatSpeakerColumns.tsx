...
import { ActivityStatus, Modality, Workshop, WorkshopAttendance } from '@prisma/client';
import { CellProps, Column } from 'react-table';

const singleChatSpeakerColumns: Column<Workshop>[] = [
    {
...
export default singleChatSpeakerColumns;
