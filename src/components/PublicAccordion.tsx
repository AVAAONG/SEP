            ...
            title={
              <div className="flex-col space-y-1.5  flex justify-between items-center">
                <div className="flex items-center space-x-4">
                  <p className="text-4xl font-bold">{workshopTotalHours}</p>
                  <h3 className="text-2xl font-semibold leading-none tracking-tight">
                    Horas académicas clubs conversacionales de realizadas
                  </h3>
                </div>
              </div>
            }
      ...
      <>
        ...
        <Accordion variant="splitted">
          ...
          >
            <div className="p-4 space-x-4 flex justify-between">
              <div className="flex-grow">
                <h4 className="font-semibold">Nivel Intermedio</h4>
                <p className="text-4xl font-bold ">{chatTotalHoursByLevel.INTERMEDIO.toFixed()}</p>
                <p className="text-base  text-black dark:text-blue-200">Horas académicas</p>
              </div>
            </div>
          </AccordionItem>
