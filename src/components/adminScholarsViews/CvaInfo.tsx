    ...
    <>
      <div className="flex flex-col w-full h-full bg-white dark:bg-black rounded-lg py-4 justify-center shadow-md ">
        <div className="w-full grid md:grid-cols-5 justify-center items-center">
          <DonutChartComponent data={dataForCharts.cvaLocation} chartTitle='Distribución por sede' />
          <DonutChartComponent data={dataForCharts.cvaModality} chartTitle='Distribución por modalidad' />
          <DonutChartComponent data={dataForCharts.hasFinishedCva} chartTitle='Distribución de becarios que han finalizado el CVA' />
          <DonutChartComponent data={dataForCharts.cvaLastModule} chartTitle='Distribución de becarios por modulo' />
          <DonutChartComponent data={dataForCharts.isCurrentlyInCva} chartTitle='Distribución de becarios que estan en el CVA' />
        </div>
      </div>
