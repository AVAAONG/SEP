    ...
    <>
      <div className="flex flex-col w-full h-full bg-white dark:bg-black rounded-lg py-4 justify-center shadow-md ">
        <div className="w-full grid md:grid-cols-5 justify-center items-center">
          ...
          <DonutChartComponent data={dataForCharts.kindOfCollage} chartTitle='Distribución por tipo de universidad' />
          <DonutChartComponent data={dataForCharts.studyArea} chartTitle='Distribución por area de estudio' />
          <DonutChartComponent data={dataForCharts.studyRegimen} chartTitle='Distribución por el regimen de estudio' />
        </div>
      </div>
