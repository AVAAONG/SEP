...
const Warning = ({ title, subtitle, children }: WarningProps) => {
  return (
    <div
      className="max-w-md p-4 mb-4 text-yellow-600 border border-yellow-300 rounded-lg bg-transparent dark:bg-transparent dark:text-yellow-400 dark:border-yellow-800"
      role="alert"
    >
