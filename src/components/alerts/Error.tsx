...
const Error = ({error}: ErrorProps) => {
    return (
        <div className="p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-transparent  dark:text-red-400 dark:border-red-800" role="alert">
            <div className="flex items-center">
                ...
                <span className="sr-only">Ah ocurrido el siguiente erorr</span>
