...
const ActivityList = ({ activityList }) => {
    return (
        <>
            <h3 className="flex items-center mb-4 text-lg font-semibold text-gray-900 dark:text-white">Actividades
                                    ...
                                    <ActivityListIcon kindOfActivity={activity.kindOfActivity}/>
                                        <div className="flex flex-col ml-3">
                                            ...
                                            <div className="flex items-center justify-start flex-1 text-sm text-green-500 dark:text-green-400 font-semibold">
                                                ...
                                                <span className="ml-1 text-gray-500 dark:text-gray-400">{activity.date}</span>
                                                <span className="ml-1 text-gray-500 dark:text-gray-400">{activity.startHour}</span>
                                                <span className="ml-2 text-emerald-700 dark:text-emerald-500 ">{activity.speaker}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
