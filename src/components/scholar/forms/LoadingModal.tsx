            ...
            <div className="relative p-4 w-full h-full transition-opacity">
                <div className="relative p-4 rounded-lg shadow bg-red-100 md:p-8 ">
                    <div className="flex flex-col justify-center items-center transition-all duration-500">
                        <h3 className="mb-3 text-sm font-bold  text-red-800 dark:text-gray-300">Ocurrio un error inesperado al guardar</h3>
                        <div className='w-1/3'>
                            <XIcon />
                        </div>
                        <div className="mt-4 flex gap-4">
                            ...
                            <a
                                ...
                                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-red-700 bg-red-200 hover:bg-red-600 hover:text-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-600"
                            >
        ...
        return (
            <div className="w-full h-full animate-pulse">
                <div className="relative p-4 rounded-lg shadow bg-green-100 md:p-8">
                    <div className="flex flex-col justify-center items-center transition-all duration-500">
                        <h3 className="mb-3 text-sm font-bold  text-emerald-700 dark:text-emerald-600">¡Tus datos se han actualizado de forma correcta!</h3>
                        <div className='w-1/3'>
