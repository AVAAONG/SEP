...
const SocialMedia = () => {
  return (
    <div className="flow-root">
      <h3 className="text-xl font-semibold dark:text-white">Redes Sociales</h3>
      ...
      <div className="col-span-6 sm:col-full">
        <button
          className="text-white bg-[#008000] hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
          type="submit"
        >
          Guardar
        </button>
