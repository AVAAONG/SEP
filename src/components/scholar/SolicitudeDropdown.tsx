    ...
    <>
      <div className="">
        <button
          ...
          className=" text-sm flex items-center justify-between w-full py-2 pl-3 pr-4  text-emerald-700 rounded hover:bg-green-100 hover:bg-transparent md:border-0 hov1er:text-green-700 md:p-0 md:w-auto dark:text-emerald-700 dark:hover:text-emerald-500 dark:border-green-700  dark:hover:bg-transparent "
        >
          Solicitudes
          <svg
        ...
        >
          ...
          >
            <li>
              <a
                href="#"
                className="block px-4 py-2 hover:bg-emerald-100 dark:hover:bg-emerald-700 dark:hover:text-white"
              >
                Carta de ingreso CVA
              </a>
            </li>
            <li>
