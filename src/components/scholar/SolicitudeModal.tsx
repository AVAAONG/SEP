        ...
        <div className="flex flex-col m-auto bg-white rounded-lg shadow dark:bg-emerald-950 !bg-opacity-100">
          ...
          <div className="p-6 space-y-3 flex flex-col justify-center ">
            ...
            <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
              Una vez que le des al boton de "Solicitar carta" se creara tu carta para solicitar el
              ingreso en la cede que seleccionaste. Esta te llegara por correo, con el fin de que
              puedas verificar que tus datos esten bien escritos.
            </p>
            <p className="text-base leading-relaxed text-green-700 dark:text-emerald-700">
              ...
              horario laboral) para hacer el retiro de su carta. Ya que para ser entregada al CVA
              esta debe de contar con sello y firma húmeda.
            </p>
          </div>
