...
const SolicitudeModal = () => {
  return (
    <div
      aria-hidden="true"
      className="z-50 fixed top-0 left-0 right-0 w-full h-full p-4 overflow-x-hidden overflow-y-auto max-h-full  bg-green-100 bg-opacity-70 dark:bg-slate-950 dark:bg-opacity-70 "
    >
          ...
          <div className="p-6 space-y-3 flex flex-col justify-center ">
            <div className="grid grid-cols-7 gap-4 w-full justify-center">
              <div className="col-span-6 ">
                ...
                >
                  indica la cede del CVA en donde desas iniciar{' '}
                </label>
            ...
            <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
              Una vez que le des al boton de "Solicitar carta" se creara tu
              carta para solicitar el ingreso en la cede que seleccionaste. Esta
              te llegara por correo, con el fin de que puedas verificar que tus
              datos esten bien escritos.
            </p>
            <p className="text-base leading-relaxed text-green-700 dark:text-emerald-700">
              Una vez realizado esto, pueden venir en cualquier momento a la
              oficina (dentro del horario laboral) para hacer el retiro de su
              carta. Ya que para ser entregada al CVA esta debe de contar con
              sello y firma húmeda.
            </p>
          </div>
