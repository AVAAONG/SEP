  ...
  return (
    <nav className="block h-12 w-full top-0 left-0 mb-4">
      <div className="flex justify-between gap-4">
        <button onClick={setUpSidebar} aria-controls="separator-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-emerald-500 rounded-lg  focus:outline-none focus:ring-2  bg-green-800 text-emerlad-400 hover:bg-emerald-950 focus:ring-emerald-600">
