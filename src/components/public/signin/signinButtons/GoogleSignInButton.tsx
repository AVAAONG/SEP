...
const GoogleSignInButton = ({ providerId, callbackUrl, cookieValue }: GoogleSignInButtonProps) => {
  ...
  return (
    <Button
      onClick={async () => toast.promise(handleSignIn(), {
