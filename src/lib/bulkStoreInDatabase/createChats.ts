...
// const ERROR_START_NUMBER = 2;

// //TENER EN CUENTA TAMBIEN EL RANGO DONDE SE COLOCA EL SPREADSHEET DE ERRORES
// const FIRST_RANGE = 'B2:L48';
// const FIRST_RANGE_MAIN_LIST = `A12:D26`;
// const FIRST_RANGE_WAITING_LIST = `A28:D`;
// //##########################################################################

// //##########################################################################
// const SECOND_RANGE = 'B49:L77';
// const SECOND_RANGE_MAIN_LIST = `A9:D23`;
// const SECOND_RANGE_WAITING_LIST = `A25:D`;
// //##########################################################################

// // al momento de colocar este rango. Se debe de cambiar el indice de donde se saca la asistencia de las listas ya que en esta la columna cambia. En vez de ser "a[3]" es "a[4]"
// //##########################################################################
// const LAST_RANGE = 'B78:L245';
