export const createEnrollementConfirmationMessage = (
  ...
  * {
  ...
  table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_heading_1 .v-container-padding-padding { padding: 40px 10px 0px !important; } #u_content_image_1 .v-container-padding-padding { padding: 10px 10px 36px !important; } #u_content_heading_5 .v-container-padding-padding { padding: 15px 10px 0px !important; } #u_content_heading_5 .v-font-size { font-size: 15px !important; } #u_content_heading_6 .v-container-padding-padding { padding: 10px 0px 5px !important; } #u_content_heading_6 .v-font-size { font-size: 23px !important; } #u_content_text_5 .v-container-padding-padding { padding: 10px !important; } #u_content_text_5 .v-font-size { font-size: 13px !important; } #u_content_text_5 .v-text-align { text-align: center !important; } #u_content_text_5 .v-line-height { line-height: 140% !important; } #u_content_button_3 .v-container-padding-padding { padding: 15px 10px 10px !important; } #u_content_button_3 .v-size-width { width: 100% !important; } #u_content_button_3 .v-font-size { font-size: 12px !important; } #u_content_text_7 .v-container-padding-padding { padding: 10px !important; } #u_content_text_7 .v-font-size { font-size: 13px !important; } #u_content_text_7 .v-text-align { text-align: center !important; } #u_content_text_7 .v-line-height { line-height: 140% !important; } #u_content_button_2 .v-container-padding-padding { padding: 15px 10px 10px !important; } #u_content_button_2 .v-size-width { width: 82% !important; } #u_content_button_2 .v-font-size { font-size: 14px !important; } #u_content_text_10 .v-container-padding-padding { padding: 5px 10px 6px !important; } #u_content_text_10 .v-font-size { font-size: 12px !important; } #u_content_text_10 .v-text-align { text-align: center !important; } #u_content_text_10 .v-line-height { line-height: 140% !important; } #u_content_image_3 .v-container-padding-padding { padding: 3px 13px 13px !important; } #u_content_heading_4 .v-container-padding-padding { padding: 0px 10px !important; } #u_content_heading_4 .v-text-align { text-align: center !important; } #u_content_text_deprecated_1 .v-container-padding-padding { padding: 5px 0px 14px 10px !important; } #u_content_text_deprecated_1 .v-font-size { font-size: 12px !important; } #u_content_text_deprecated_1 .v-text-align { text-align: center !important; } }
      </style>
  ...
  <div class="u-row-container" style="padding: 0px;background-color: #049640">
    <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
      <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
        <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: #049640;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: transparent;"><![endif]-->
  ...
  <table id="u_content_heading_1" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:16px 10px 13px;font-family:'Open Sans',sans-serif;" align="left">
          
    <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 25px; "><strong>¡Hola, ${scholarName}!</strong></h1>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
        ...
        <img align="center" border="0" src="https://cdn.templates.unlayer.com/assets/1679299847670-Asset%201.png" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 77%;max-width: 446.6px;" width="446.6"/>
  ...
  <table id="u_content_heading_5" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 9px 14px 10px;font-family:'Open Sans',sans-serif;" align="left">
          
    <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; color: #000000; line-height: 120%; text-align: center; word-wrap: break-word; font-size: 24px; "><p style="line-height: 120%;"><strong>Este correo confirma tu inscripción a la siguiente actividad:</strong></p></h1>
  ...
  <table id="u_content_heading_6" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:8px 0px 11px;font-family:'Open Sans',sans-serif;" align="left">
          
    <h1 class="v-text-align v-line-height v-font-size" style="margin: 0px; color: #009640; line-height: 120%; text-align: center; word-wrap: break-word; font-size: 28px; "><p style="line-height: 120%;"><strong>${activityName}</strong></p></h1>
  ...
  <table id="u_content_text_5" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align v-line-height v-font-size" style="line-height: 100%; text-align: center; word-wrap: break-word;">
      <p style="line-height: 140%;">Recuerda, 👀</p>
  <p style="line-height: 140%;"><span style="background-color: #fbeeb8; line-height: 18.2px;"><strong>Inscribirse es un compromiso.</strong></span></p>
  <p style="line-height: 140%;"> </p>
  <p style="line-height: 140%;"><span style="color: #2dc26b; line-height: 18.2px;"><em><strong><span style="line-height: 18.2px;">¡Es crucial para nosotros y para el éxito de la actividad que asistas!</span></strong></em></span></p>
    </div>
  ...
  <div class="v-text-align" align="center">
    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href=${activityLink} style="height:39px; v-text-anchor:middle; width:361px;" arcsize="25.5%"  stroke="f" fillcolor="#049640"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Open Sans',sans-serif;"><![endif]-->  
      <a href=href=${activityLink} target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box;display: inline-block;font-family:'Open Sans',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #049640; border-radius: 10px;-webkit-border-radius: 10px; -moz-border-radius: 10px; width:62%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #CCC; border-top-style: solid; border-top-width: 0px; border-left-color: #CCC; border-left-style: solid; border-left-width: 0px; border-right-color: #CCC; border-right-style: solid; border-right-width: 0px; border-bottom-color: #CCC; border-bottom-style: solid; border-bottom-width: 0px;font-family: 'Montserrat',sans-serif; font-size: 16px;font-weight: 700; ">
        <span class="v-line-height" style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Revisar actividad </span></span>
      </a>
  ...
  <table id="u_content_text_7" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align v-line-height v-font-size" style="line-height: 140%; text-align: center; word-wrap: break-word;">
      <p style="line-height: 140%;">En el caso de que no puedas asistir a la actividad, puedes cederle un cupo a otro becario </p>
    </div>
  ...
  <table id="u_content_text_10" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:0px 50px 10px;font-family:'Open Sans',sans-serif;" align="left">
          
    <div class="v-text-align v-line-height v-font-size" style="font-size: 13px; line-height: 140%; text-align: center; word-wrap: break-word;">
      <p style="line-height: 140%;"><span style="color: #e03e2d; line-height: 18.2px;"><em>Esta funcionalidad esta permitida <strong>hasta el inicio de la actividad</strong>, despues e ese tiempo no podras cancelar la actividad y se te marcara como una <strong>inasistencia.</strong></em></span></p>
    </div>
